...
struct FPostProcessSettings
{
	...
	float                                              TotalWeight_Bloom;                                		// 0x0080 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              TotalWeight_DOF;                                  		// 0x0084 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              TotalWeight_MotionBlur;                           		// 0x0088 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              TotalWeight_Scene;                                		// 0x008C (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              fVolumeLightDensity;                              		// 0x0090 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              fVolumeLightWeight;                               		// 0x0094 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              fVolumeLightImageBlurKernelSize;                  		// 0x0098 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector2D                                   vLightPixelPos;                                   		// 0x009C (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
...
// ScriptStruct Engine.AeroSet.DirectionalLightSetting
// 0x0028
struct FDirectionalLightSetting
{
	unsigned long                                      Enable : 1;                                       		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	float                                              Brightness;                                       		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FLinearColor                                LightColor;                                       		// 0x0008 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	class UMaterialInterface*                          FunctionSourceMaterial;                           		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FRotator                                    Rotation;                                         		// 0x001C (0x000C) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.AeroSet.SkyLightSetting
// 0x002C
struct FSkyLightSetting
{
	...
	float                                              Brightness;                                       		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FLinearColor                                LightColor;                                       		// 0x0008 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	float                                              LowerBrightness;                                  		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FLinearColor                                LowerLightColor;                                  		// 0x001C (0x0010) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.AeroSet.S1PostProcessing
// 0x00A8
struct FS1PostProcessing
{
	unsigned long                                      Enable : 1;                                       		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FPostProcessSettings                        PostProcessSetting;                               		// 0x0004 (0x00A4) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.AeroSet.S1DefaultPostProcessing
// 0x0024
struct FS1DefaultPostProcessing
{
	unsigned long                                      Enable : 1;                                       		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	float                                              DistFogNearEnd;                                   		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DistFogDensity;                                   		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DistFogMaxDensity;                                		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              FogIncreaseExponent;                              		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FLinearColor                                DistFogColor;                                     		// 0x0014 (0x0010) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.AeroSet.S1EnvironmentMapSetting
// 0x0008
struct FS1EnvironmentMapSetting
{
	unsigned long                                      Enable : 1;                                       		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	class UTextureCube*                                Texture;                                          		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.AeroSet.S1LightProbeSetting
// 0x0008
struct FS1LightProbeSetting
{
	unsigned long                                      Enable : 1;                                       		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	class UTextureCube*                                Texture;                                          		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.AeroSet.SkyBackdrop
// 0x000C
struct FSkyBackdrop
{
	class UStaticMesh*                                 Mesh;                                             		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                Yaw;                                              		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                TranslucencySortPriority;                         		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.AeroSet.SkyMesh
// 0x0034
struct FSkyMesh
{
	class UStaticMesh*                                 SkyMesh;                                          		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FLinearColor                                Color;                                            		// 0x0004 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	struct FLinearColor                                Color2;                                           		// 0x0014 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	struct FRotator                                    Rotation;                                         		// 0x0024 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	int                                                TranslucencySortPriority;                         		// 0x0030 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.AeroSet.CloudMesh
// 0x000C
struct FCloudMesh
{
	class UStaticMesh*                                 Mesh;                                             		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
// ScriptStruct Engine.AeroSet.SkyParticle
// 0x0010
struct FSkyParticle
{
	class UParticleSystem*                             SkyParticleSystem;                                		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Height;                                           		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                ParticleSystemYaw;                                		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                TranslucencySortPriority;                         		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.AeroSet.SkySystem
// 0x0034
struct FSkySystem
{
	unsigned long                                      Enable : 1;                                       		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FSkyBackdrop                                Backdrop;                                         		// 0x0004 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FSkyMesh >                          SkyMeshes;                                        		// 0x0010 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FCloudMesh                                  CloudMesh;                                        		// 0x001C (0x000C) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FSkyParticle >                      SkyParticles;                                     		// 0x0028 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};

// ScriptStruct Engine.AeroSet.ClimateSetting
// 0x0010
struct FClimateSetting
{
	unsigned long                                      Enable : 1;                                       		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	TArray< class UParticleSystem* >                   ClimateParticles;                                 		// 0x0004 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};

// ScriptStruct Engine.AeroSet.S1WindSetting
// 0x0018
struct FS1WindSetting
{
	unsigned long                                      Enable : 1;                                       		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	int                                                Yaw;                                              		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Strength;                                         		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
// ScriptStruct Engine.AeroSet.S1LensFlare
// 0x0008
struct FS1LensFlare
{
	unsigned long                                      Enable : 1;                                       		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	float                                              Opacity;                                          		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FAnimBlendChild
{
	...
	struct UAnimNode_FBoneAtom                         RootMotion;                                       		// 0x001C (0x0020) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
...
struct FSoundGroupProperties
{
	...
	int                                                MaxConcurrentPlayCount;                           		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FSoundGroup
{
	struct FSoundGroupProperties                       Properties;                                       		// 0x0000 (0x0018) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       GroupName;                                        		// 0x0018 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FName >                             ChildGroupNames;                                  		// 0x0020 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};

// ScriptStruct Engine.AudioDevice.SoundModeData
// 0x0014
struct FSoundModeData
{
	struct FDouble                                     SoundModeStartTime;                               		// 0x0000 (0x0008) [0x0000000000000000]              
	struct FDouble                                     SoundModeEndTime;                                 		// 0x0008 (0x0008) [0x0000000000000000]              
	class USoundMode*                                  SoundMode;                                        		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
struct FStaticMeshComponentLODInfo
{
	...
	class UObject*                                     AmbientVertexBuffers;                             		// 0x001C (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
// ScriptStruct Engine.IOTerrainMaterial.TerrainMaterialResource
// 0x0000
struct UIOTerrainMaterial_FTerrainMaterialResource
{
};
...
{
	struct FPostProcessSettings                        LastSettings;                                     		// 0x0000 (0x00A4) [0x0000000000000000]              
	class APostProcessVolume*                          LastVolumeUsed;                                   		// 0x00A4 (0x0004) [0x0000000000000000]              
	float                                              BlendStartTime;                                   		// 0x00A8 (0x0004) [0x0000000000000000]              
	float                                              LastBlendTime;                                    		// 0x00AC (0x0004) [0x0000000000000000]              
};
...
struct FPlayerEvent
{
	...
	TArray< struct FGameplayEvent >                    Events;                                           		// 0x0020 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
// ScriptStruct Engine.S1InterpTrackPegasusParam.PegasusTrackKey
// 0x000C
struct FPegasusTrackKey
{
	float                                              Time;                                             		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                State;                                            		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                PlayCount;                                        		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
// ScriptStruct Engine.Terrain.GlobalFoliageMinMax
// 0x0008
struct FGlobalFoliageMinMax
{
	float                                              MinScale;                                         		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              MaxScale;                                         		// 0x0004 (0x0004) [0x0000000000000000]              
};

// ScriptStruct Engine.Terrain.FoliageGuid
// 0x0010
struct FFoliageGuid
{
...
// ScriptStruct Engine.Terrain.GlobalFoliageInstance
// 0x0040
struct FGlobalFoliageInstance
{
	struct FVector                                     Location;                                         		// 0x0000 (0x000C) [0x0000000000000000]              
	struct FVector                                     XAxis;                                            		// 0x000C (0x000C) [0x0000000000000000]              
	struct FVector                                     YAxis;                                            		// 0x0018 (0x000C) [0x0000000000000000]              
	struct FVector                                     ZAxis;                                            		// 0x0024 (0x000C) [0x0000000000000000]              
	struct FVector2D                                   StaticLightingTexCoord;                           		// 0x0030 (0x0008) [0x0000000000000000]              
	float                                              BoundingRadius;                                   		// 0x0038 (0x0004) [0x0000000000000000]              
	float                                              DistanceFactorSquared;                            		// 0x003C (0x0004) [0x0000000000000000]              
};

// ScriptStruct Engine.Terrain.FoliageInstancePerComponent
// 0x004C
struct FFoliageInstancePerComponent
{
	int                                                SectionBaseX;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                SectionBaseY;                                     		// 0x0004 (0x0004) [0x0000000000000000]              
	int                                                TrueSectionSizeX;                                 		// 0x0008 (0x0004) [0x0000000000000000]              
	int                                                TrueSectionSizeY;                                 		// 0x000C (0x0004) [0x0000000000000000]              
	TArray< struct FGlobalFoliageInstance >            FoliageData;                                      		// 0x0010 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FUntypedBulkData_Mirror                     FoliageInstanceBulkData;                          		// 0x001C (0x0030) [0x0000000000001000]              ( CPF_Native )
};

// ScriptStruct Engine.Terrain.GlobalFoliageMeshStore
// 0x0054
struct FGlobalFoliageMeshStore
{
	class UStaticMesh*                                 StaticMesh;                                       		// 0x0000 (0x0004) [0x0000000000000000]              
	class UMaterialInterface*                          Material;                                         		// 0x0004 (0x0004) [0x0000000000000000]              
	float                                              Density;                                          		// 0x0008 (0x0004) [0x0000000000000000]              
	float                                              MaxDrawRadius;                                    		// 0x000C (0x0004) [0x0000000000000000]              
	float                                              MinTransitionRadius;                              		// 0x0010 (0x0004) [0x0000000000000000]              
	float                                              MinScale;                                         		// 0x0014 (0x0004) [0x0000000000000000]              
	float                                              MaxScale;                                         		// 0x0018 (0x0004) [0x0000000000000000]              
	float                                              MinUniformScale;                                  		// 0x001C (0x0004) [0x0000000000000000]              
	float                                              MaxUniformScale;                                  		// 0x0020 (0x0004) [0x0000000000000000]              
	float                                              MinThinningRadius;                                		// 0x0024 (0x0004) [0x0000000000000000]              
	int                                                Seed;                                             		// 0x0028 (0x0004) [0x0000000000000000]              
	float                                              SwayScale;                                        		// 0x002C (0x0004) [0x0000000000000000]              
	float                                              AlphaMapThreshold;                                		// 0x0030 (0x0004) [0x0000000000000000]              
	float                                              SlopeRotationBlend;                               		// 0x0034 (0x0004) [0x0000000000000000]              
	struct FFoliageGuid                                MeshGuid;                                         		// 0x0038 (0x0010) [0x0000000000000000]              
	TArray< struct FFoliageInstancePerComponent >      FoliageDataPerComponent;                          		// 0x0048 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};

// ScriptStruct Engine.Terrain.GlobalFoliageMesh
// 0x0054
struct FGlobalFoliageMesh
{
	class UStaticMesh*                                 StaticMesh;                                       		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UMaterialInterface*                          Material;                                         		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	...
	struct FFoliageGuid                                MeshGuid;                                         		// 0x0038 (0x0010) [0x0000000000000000]              
	TArray< struct FFoliageInstancePerComponent >      FoliageDataPerComponent;                          		// 0x0048 (0x000C) [0x0000000000001000]              ( CPF_Native )
};

// ScriptStruct Engine.Terrain.GlobalFoliageLayer
// 0x0018
struct FGlobalFoliageLayer
{
	struct FString                                     Name;                                             		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FGlobalFoliageMesh >                FoliageLayer;                                     		// 0x000C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
// ScriptStruct Engine.Terrain.TerrainVegetationInstance
// 0x0004
struct FTerrainVegetationInstance
{
	class UPrimitiveComponent*                         Component;                                        		// 0x0000 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
};

// ScriptStruct Engine.Terrain.TerrainVegetation
// 0x0028
struct FTerrainVegetation
{
	class UActorFactory*                               Factory;                                          		// 0x0000 (0x0004) [0x0000000004000001]              ( CPF_Edit | CPF_EditInline )
	float                                              MinScale;                                         		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxScale;                                         		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Density;                                          		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              SlopeRotationBlend;                               		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      RandomRotation : 1;                               		// 0x0014 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	TArray< struct FTerrainVegetationInstance >        Instances;                                        		// 0x0018 (0x000C) [0x0000000000480000]              ( CPF_Component | CPF_NeedCtorLink )
	unsigned long                                      LockOn : 1;                                       		// 0x0024 (0x0004) [0x0000000000000000] [0x00000001] 
};

// ScriptStruct Engine.Terrain.TerrainVegetationLayer
// 0x0018
struct FTerrainVegetationLayer
{
	struct FString                                     Name;                                             		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FTerrainVegetation >                Vegetations;                                      		// 0x000C (0x000C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
};
...
// 0x0000
struct ATerrain_FTerrainMaterialResource
{
};
