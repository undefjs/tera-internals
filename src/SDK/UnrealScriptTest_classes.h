...
{
public:
	class UCTSimpleNestObject*                         SimpleNestObject;                                 		// 0x01C0 (0x0004) [0x0000000004400009]              ( CPF_Edit | CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
	struct FComplexNestStruct                          SimpleNestObjectStruct;                           		// 0x01C4 (0x0010) [0x0000000004400009]              ( CPF_Edit | CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
...
{
public:
	class UCTNoNesting*                                UnmodifiedComponent_SingleRef;                    		// 0x01C0 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UCTNoNesting*                                ModifiedComponent_SingleRef;                      		// 0x01C4 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UCTNoNesting*                                UnmodifiedComponent_MultipleRef;                  		// 0x01C8 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UCTNoNesting*                                ModifiedComponent_MultipleRef;                    		// 0x01CC (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	TArray< class UCTNoNesting* >                      UnmodifiedComponent_Array;                        		// 0x01D0 (0x000C) [0x0000000004480009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_NeedCtorLink | CPF_EditInline )
	TArray< class UCTNoNesting* >                      ModifiedComponent_Array;                          		// 0x01DC (0x000C) [0x0000000004480009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_NeedCtorLink | CPF_EditInline )
...
{
public:
	class UCTSimpleNestParent*                         UnmodifiedNestParent_SingleRef;                   		// 0x01C0 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UCTSimpleNestParent*                         ModifiedNestParent_SingleRef;                     		// 0x01C4 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UCTSimpleNestParent*                         UnmodifiedNestParent_MultipleRef;                 		// 0x01C8 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UCTSimpleNestParent*                         ModifiedNestParent_MultipleRef;                   		// 0x01CC (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	TArray< class UCTSimpleNestParent* >               UnmodifiedNestParent_Array;                       		// 0x01D0 (0x000C) [0x0000000004480009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_NeedCtorLink | CPF_EditInline )
	TArray< class UCTSimpleNestParent* >               ModifiedNestParent_Array;                         		// 0x01DC (0x000C) [0x0000000004480009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_NeedCtorLink | CPF_EditInline )
...
{
public:
	class UNestingTest_FirstLevelComponent*            Component;                                        		// 0x01C0 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UNestingTest_FirstLevelSubobject*            Subobject;                                        		// 0x01C4 (0x0004) [0x0000000004400009]              ( CPF_Edit | CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
...
// 0x0019 (0x01D9 - 0x01C0)
class ATest0023_MetaData : public AActor
{
public:
	struct FString                                     MemberString;                                     		// 0x01C0 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FExampleStruct                              MemberStruct;                                     		// 0x01CC (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned char                                      MemberEnum;                                       		// 0x01D8 (0x0001) [0x0000000000000001]              ( CPF_Edit )
...
{
public:
	class UInheritanceTestDerived*                     ComponentVar;                                     		// 0x01C0 (0x0004) [0x00000000040A0009]              ( CPF_Edit | CPF_ExportObject | CPF_EditConst | CPF_Component | CPF_EditInline )
	class UInheritanceTestDerived*                     RuntimeComponent;                                 		// 0x01C4 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
...
{
public:
	class UTest0020_StructDefaults*                    StructDefaultTestObj;                             		// 0x01C8 (0x0004) [0x0000000004400009]              ( CPF_Edit | CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
