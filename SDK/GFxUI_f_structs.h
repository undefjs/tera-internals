...
struct UGFxEICallbackHandler_eventEICallback_Parms
{
...
{
	int                                                Index;                                            		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	struct FASDisplayInfo                              D;                                                		// 0x0004 (0x001C) [0x0000000000000080]              ( CPF_Parm )
};
...
{
	int                                                Index;                                            		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	struct FASDisplayInfo                              ReturnValue;                                      		// 0x0004 (0x001C) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
{
	struct FASDisplayInfo                              D;                                                		// 0x0000 (0x001C) [0x0000000000000080]              ( CPF_Parm )
};
...
{
	struct FASDisplayInfo                              ReturnValue;                                      		// 0x0000 (0x001C) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
// [0x00024401] ( FUNC_Final | FUNC_Native )
struct UGFxValue_execGetMember_Parms
{
	struct FString                                     member;                                           		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	class UClass*                                      Type;                                             		// 0x000C (0x0004) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
	class UGFxValue*                                   ReturnValue;                                      		// 0x0010 (0x0004) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
